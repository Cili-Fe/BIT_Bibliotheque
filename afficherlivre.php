...
<body>
            ...
            <div class="modal-dialog">
                <div class="modal-content">		
                    <div class="modal-body">
                        <div class="container">
                            <form action="livreInsert.php" method="POST">
                                <h2 class="text-center">Ajouter un livre</h2><br><br> 
                                <div class="container">
                                    <div class="form-group">
                                        <input type="text" name="titre" class="form-control" placeholder="titre" required="required" autocomplete="">
                                    </div><br><br>
                                    <div class="form-group">
                                        <input type="text" name="auteur" class="form-control" placeholder="auteur" required="required" autocomplete="">
                                    </div><br><br>
                                    <div class="form-group">
                                        <input type="text" name="publication" class="form-control" placeholder="publication" required="required" autocomplete="">
                                    </div><br><br>
                                    <div class="form-group">
                                        <!-- <input type="text" name="field" class="form-control" placeholder="field" required="required" autocomplete=""> -->
                                        <select name="categorie" id="" class="form-group">
                                            <option value="roman">roman</option>
                                            <option value="dev perso">dev perso</option>
                                            <option value="programmation">programmation</option>
                                        </select>
                                    </div><br><br>
                                    <div class="form-group">
                                        <input type="text" name="edit" class="form-control" placeholder="Edition" required="required" autocomplete="">
                                    </div><br><br>
                                    <div class="formGroup">
    ...
    try{
         ...
         $sql = "SELECT * FROM livre WHERE disponible = 1";
...
?>
            <table class=" table table-hover mt-5">
                ...
                ?>
                    <tr class="">
                        <td><?= $etudiant->titre?></td>
                        <td><?= $etudiant->auteur?></td>
                        <td><?= $etudiant->categorie?></td>
                        <td><?= $etudiant->disponible?></td>
                        <td><?= $etudiant->publication?></td>
                        <td><?= $etudiant->edit?></td>
                    </tr> 
                <?php
                } ?>
